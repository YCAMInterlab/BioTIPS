...
###### <font color = "Pink">重要：DNAサンプルの基準</font>
...
<font color = "Pink">重要：このプロトコルでは、シーケンステザー（SQT）は使用しません  
...
<font color = "Pink">重要：フローセルからバッファーを引き戻すときは注意が必要です  
...
<font color = "Pink">重要：
ローディングビーズ（LB）チューブにはビーズの懸濁液が入っています  
