...
- フラグメンテーションミックス（FRA）：解凍の必要はありません、短時間スピンダウンし、ピペッティングでよく混ぜます
- ラピッドアダプター（RAP）：解凍の必要はありません、短時間スピンダウンし、ピペッティングでよく混ぜます
...
| 試薬 | 解凍 | 短時間のスピンダウン | ピペッティングでよく混ぜる |
| :--- | :--- | :--- | :--- |
| フラグメンテーションミックス（FRA） | なし | あり | あり |
| ラピッドアダプター（RAP） | なし | あり | あり |
| シーケンスバッファー（SQB） | あり | あり | \*あり |
| ローディングビーズ（LB） | あり | あり | 使用直前にピペッティングまたはボルテックスにより混和します |
| フラッシュバッファー（FLB） | あり | あり | \*あり |
| フラッシュテザー（FLT） | あり | あり | あり |
\* SQBとFLBについては、ボルテックスでの攪拌後、マクロフュージを用いてスピンダウンすることをお勧めします。
