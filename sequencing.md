...
- 不要なせん断を避けるために、マイクロチューブを指で軽く叩いて混ぜます
...
以下のキットの内容物を、室温で解凍し、マイクロフュージを用いて短時間スピンダウンし、ピペッティングにより混合します  
...
- PCRチューブを指で軽く叩いて混ぜて、マイクロフュージでスピンダウンします  
...
- 混和したフラッシュテザー（FLT）**30μl** を、フラッシュバッファー（FLB）のチューブに直接加え、上下にピペッティングして混合して、プライミングミックスを準備します

#### プライミングポートから 800µl のプライミングミックスを充填します
...
#### （SpotONサンプルポートではなく！）プライミングポートから 200 µl のプライミングミックスを充填します    
   - 気泡の混入を防ぐため、充填前にチップの先から少しプライミングミックスを出して、捨てます 
   - 同じく、気泡の混入を防ぐため、チップ内にプライミングミックスが残った状態で充填をおわります
